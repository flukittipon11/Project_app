        ...
        return (
            <ScrollView style={styles.bgManage}>
                ...
                <View style={styles.containerform}>
                    <View style={{ alignSelf: 'center', marginBottom: 10 }}>
                        <Text style={{ fontSize: 20, fontWeight: 'bold', alignSelf: 'center' }}>การบันทึกข้อมูล</Text>
                ...
                <View style={{ flexDirection: 'row', alignSelf: 'center', marginTop: 5 }}>
                    ...
                    <TouchableOpacity style={styles.btdelete} onPress={this.openTwoButtonAlert}>
                        <Text style={{ color: '#fff', fontSize: 16 }}><Image source={{ uri: 'https://sv1.picz.in.th/images/2021/04/25/Ao23YJ.png' }} style={{ width: 20, height: 20 }} /> ลบข้อมูล</Text>
                    </TouchableOpacity>
                </View>
                <TouchableOpacity style={styles.btedit} onPress={this.openTwoButtonAlert} onPress={() => this.farmEdit()}>
                    <Text style={{ color: '#594F4F', fontSize: 16 }}><Image source={{ uri: 'https://sv1.picz.in.th/images/2021/04/25/AoCwQV.png' }} style={{ width: 25, height: 25 }} /> แสดงข้อมูลการบันทึก</Text>
                </TouchableOpacity>
                {/* </ImageBackground> */}
            </ScrollView>
        )

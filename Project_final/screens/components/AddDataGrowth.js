...
import { StyleSheet, ScrollView, ActivityIndicator, View, Text, Alert, ImageBackground, TouchableOpacity } from 'react-native'
...
class AddDataGrowth extends Component {
    constructor() {
        super();
        this.state = {
            key: '',
    ...
    storeUser() {
        if (this.state.Farm_name == '') {
            ...
            const updateDBRef = global.firebase.firestore().collection('Corn-growth').doc(this.props.route.params.userKey);
            updateDBRef.collection('Sheath-Corn').add({
            ...
            <ScrollView>
                <View>
                    ...
                    <View style={{ flexDirection: 'row', alignSelf: 'center', marginTop: 5 }}>
                        <TouchableOpacity style={styles.btclick} onPress={() => this.storeUser()}>
                            <Text style={{ color: '#fff', fontSize: 16 }}><Image source={{ uri: 'https://sv1.picz.in.th/images/2021/04/25/Ao2Bhy.png' }} style={{ width: 20, height: 20 }} /> บันทึกข้อมูล</Text>
                        </TouchableOpacity>
